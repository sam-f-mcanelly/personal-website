    ...
    <div className="min-h-screen text-slate-950 relative z-10 dark:text-slate-50 ">
      <main className="container px-4 md:px-6 py-8">
        ...
        <div className="space-y-4 text-white">
          <p>
            Welcome to Sam McAnelly&apos;s portfolio website. By accessing this
          ...
          <p>
            This website is provided for informational purposes only. You may
            not use this website for any unlawful purpose or in any way that
          ...
          <p>
            ...
            images, is the property of Sam McAnelly and protected by copyright
            laws. You may not reproduce, distribute, or use any content from
            this website without explicit permission.
          </p>
          <h2 className="text-xl font-semibold mt-4 mb-2 text-neutral-subheading">
            3. Disclaimer
          </h2>
          <p>
            ...
            representations or warranties, express or implied. Sam McAnelly
          ...
          <p>
            Sam McAnelly will not be liable to you in relation to the contents
            of, or use of, or otherwise in connection with, this website for any
          ...
          <p>
            Sam McAnelly reserves the right to modify these Terms of Service at
            any time. We will post any changes on this page and update the
