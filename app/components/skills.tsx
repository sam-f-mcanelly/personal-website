    ...
    <div className="mt-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-black/60 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-neutral-accent/30 transition-all duration-300 ease-in-out hover:bg-black/80 hover:border-neutral-accent/50 hover:shadow-xl hover:scale-[1.02] dark:border-slate-800">
          <h3 className="text-lg font-semibold mb-2 text-neutral-heading">Amazon Web Systems</h3>
          <div className="flex flex-wrap gap-2">
            {['Lambda', 'API Gateway', 'CloudFormation', 'CloudWatch', 'SQS'].map((skill) => (
              <span
                key={skill}
        ...
        <div className="bg-black/60 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-neutral-accent/30 transition-all duration-300 ease-in-out hover:bg-black/80 hover:border-neutral-accent/50 hover:shadow-xl hover:scale-[1.02] dark:border-slate-800">
          <h3 className="text-lg font-semibold mb-2 text-neutral-heading">Languages</h3>
          <div className="flex flex-wrap gap-2">
            {['Kotlin', 'Java', 'TypeScript', 'JavaScript', 'Python'].map((skill) => (
              <span
                key={skill}
        ...
        <div className="bg-black/60 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-neutral-accent/30 transition-all duration-300 ease-in-out hover:bg-black/80 hover:border-neutral-accent/50 hover:shadow-xl hover:scale-[1.02] dark:border-slate-800">
          <h3 className="text-lg font-semibold mb-2 text-neutral-heading">Frameworks</h3>
          <div className="flex flex-wrap gap-2">
        ...
        <div className="bg-black/60 backdrop-blur-sm p-6 rounded-lg shadow-lg border border-neutral-accent/30 transition-all duration-300 ease-in-out hover:bg-black/80 hover:border-neutral-accent/50 hover:shadow-xl hover:scale-[1.02] dark:border-slate-800">
          <h3 className="text-lg font-semibold mb-2 text-neutral-heading">Areas of Focus</h3>
          <div className="flex flex-wrap gap-2">
            {[
